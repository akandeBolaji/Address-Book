...
function addcontactField() {
    ...
    addcontactdiv.innerHTML = "<label class='text-center'><em>Add/Edit <br> Contact </em></label>" +
        "<input type='text' name='fname' placeholder='First Name'>" +
        "<input type='text' name='lname' placeholder='Last Name'class='' >" +
        "<input type='text' name='number' placeholder='Phone Number' class=''>" +
        "<input type='text' name='email' placeholder='E-mail' class=''><button onclick ='addContact()' class='ml-1'>Add</button>"
